...
const articles = [
  {
    ...
    description:
      "正規表現の基本と、ECMAScript（JavaScript）における利用方法を紹介",
    isNew: true,
  },
  {
    ...
    description:
      "Ruby on Rails 7にフォーカスし、クライアントサイド開発のためのさまざまな機能を、API開発やリアルタイムWeb開発も絡めながら紹介",
    isNew: false,
  },
  {
    ...
    description:
      "再利用性とカプセル化の特性を持った、部品化されたUIをブラウザで扱う手法について解説",
    isNew: true,
  },
  {
